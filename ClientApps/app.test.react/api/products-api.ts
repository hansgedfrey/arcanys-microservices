...
export class InventoryItemsClient {
     ...
     * @return Success
     */
    inventoryItems(query: string | undefined, page: number): Promise<SearchInventoryResponse> {
...
export class ProductsClient {
     ...
     * @return Success
     */
    products(query: string | undefined, page: number): Promise<SearchProductsResponse> {
